    ...
    return (
        <>
            <div className=' fixed top-0 right-0 left-0 bg-transparent border-b-amber-900 z-50'>
                ...
                <div className='backdrop-blur-md bg-white/10 border-b border-amber-500 justify-between '>
                    <div className='flex flex-row py-4 px-4 justify-between items-center '>
                        ...
                        <div className='pace-y-2 z-50'>
                            ...
                            <ul className=' hidden md:flex border-b border-amber-950 p-3 text-amber-950'>
                                ...
                                {
                                    open && (
                                        <div className="md:hidden bg-white/20 backdrop-blur-md text-white px-6 py-4 space-y-3">
